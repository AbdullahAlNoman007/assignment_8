...
const getProfile = (0, trycatch_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateProfile = (0, trycatch_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_service_1.userService.updateProfile(req.user, req.body);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
